...
> This file was migrated from `docs/specs/0000-project-overview.md` as part of the unified requirement/task/tracker restructure. The original content is preserved below.
