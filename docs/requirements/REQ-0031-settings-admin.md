...
> This file was migrated from `docs/specs/0031-settings-admin.md` as part of the unified requirement/task/tracker restructure. The original content is preserved below.
