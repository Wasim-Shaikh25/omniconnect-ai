...
- **Changelog entry:** See `CHANGELOG.md` for TASK-0020.
...
Implementation task for REQ-0020. Implementation details and code references were captured in the original spec and should be expanded here as work is touched.
