...
- **Tracker:** `docs/trackers/TRACKER-0031-settings-admin.md`
- **Changelog entry:** See `CHANGELOG.md` for TASK-0031.
- **Last updated:** 2026-07-29

## 1. Summary

Implementation task for REQ-0031. Implementation details and code references were captured in the original spec and should be expanded here as work is touched.
