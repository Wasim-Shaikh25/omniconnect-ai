...
- **Status:** Implemented (Batch 3 complete: Shopify migrated to `ConfigInterpreter`, `shopify.connector.ts` deleted)
- **Owner:** wasim
...
- [x] Batch 3 acceptance criteria met: `ConfigInterpreter` multi-step support, built-in Shopify mapping, `shopify.connector.ts` deleted.
- [x] All verification steps above pass.

## 4. Notes / Blockers

- Status: Implemented — Batch 3 complete in `devin/req-0078-shopify-adapter-mapping-1786018026`.
