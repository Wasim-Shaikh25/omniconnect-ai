...
const helpSections: HelpSection[] = [
  {
    ...
    content: (
      <>
        <p className="mb-2">OmniConnect AI is a multi-tenant SaaS that links your Shopify store to Facebook and Instagram and automates customer engagement with AI.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">On a store page, use the <strong>Connection</strong> card to link Shopify. In development you can leave the fields blank to use the Mock provider.</p>
        <p>After connecting, click <strong>Sync products</strong> to import the product catalog. This local catalog is used for AI product recommendations, shoppable media tags, and back-in-stock alerts.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">Link a Facebook Page or Instagram Business account in the <strong>Meta integration</strong> section. In production the app uses the Meta Graph API and webhooks to receive messages, comments, and follower events.</p>
        <p>For local testing, use the <strong>Dev simulator</strong> on the store page to simulate inbound messages, follows, and comments without a live Meta app.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">The AI assistant replies to customer messages automatically. Configure it from the store page:</p>
        ...
        <p className="mt-2">If the assistant starts a reply with <code>[ESCALATE]</code>, the conversation is marked for human handoff.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">The <strong>Conversations</strong> page lists every customer thread. Click a thread to view messages and toggle between AI and human control.</p>
        <p>Click <strong>Take over</strong> to pause AI replies; staff can then type responses. Click <strong>Resume AI</strong> to return control to the assistant.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">Automatically greet new Instagram/Facebook followers with a personalized coupon. Enable it from <strong>First-time follower campaign</strong> under a store.</p>
        <p>When a follow event arrives, the system creates a unique discount code, records it in the customer profile, and opens a conversation with a welcome message.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">Open <strong>Commerce catalog</strong> from a store page to push products to Meta and create shoppable posts.</p>
        <ul className="list-disc ml-5 space-y-1">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">The <strong>Comments & mentions</strong> page queues inbound comments. Each comment is classified by intent and sentiment and receives a suggested auto-reply. Staff can reply or hide comments manually.</p>
        <p>The <strong>Leads</strong> page captures leads from Lead Ads, DMs, comments, and follows and scores them based on source and intent signals.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">The <strong>Growth</strong> page is a hub for advocacy and conversational commerce:</p>
        <ul className="list-disc ml-5 space-y-1">
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-2">The bell icon in the top bar shows unread notifications. The <strong>Notifications</strong> page lists all events such as new messages, followers, coupons, escalations, and campaign activity. Mark items as read to clear the badge.</p>
      </>
    ),
  },
  {
