...
Configurable, multi-model-ready AI customer assistant.
...
> AIProvider interface (complete); AssistantService (generateReply); events: ReplyGenerated, EscalationRequested.
