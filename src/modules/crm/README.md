...
Customer memory system for personalization.
...
> CustomerMemory (getProfile, recordInteraction, tag, recordCoupon); events: FirstInteractionDetected, CustomerProfileUpdated.
